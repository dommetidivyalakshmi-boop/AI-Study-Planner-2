...
.main-title {
    background: linear-gradient(90deg, #dceeff, #a3cfff);
    padding: 25px;
    border-radius: 15px;
    margin-bottom: 20px;
}
...
.title-text h1 {
    ...
    /* Center Welcome & Quote Box Styling */
    .welcome-box {
    ...
    /* How it works workflow footer step cards */
    .step-card {
        background-color: #ffffff;
...
if st.session_state.plan_generated:
    ...
    if st.button(
        ...
        st.session_state.study_plan = new_plan
